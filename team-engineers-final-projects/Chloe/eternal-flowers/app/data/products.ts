...
export const products: Product[] = [
  {
    ...
    description: 'A beautiful pink bouquet featuring sparkling roses, a golden tiara, and custom age ribbon. Eternal beauty that lasts forever! The perfect gift to make her feel like royalty on her special day!',
    price: 30,
    category: 'birthday',
    colors: ['pink', 'red', 'white', 'peach', 'emerald-green', 'purple', 'pink-gold'],
    customizable: true,
    features: ['Golden Tiara', 'Custom Age Ribbon', 'Crystal Centers', 'Designer Wrapping'],
  ...
  },
  {
    ...
    description: 'Our grandest birthday arrangement featuring deep red sparkling roses, a premium crystal tiara, and luxury designer wrapping with custom ribbon. Eternal beauty that lasts forever!',
    price: 35,
    category: 'birthday',
    colors: ['pink', 'red', 'white', 'peach', 'emerald-green', 'purple', 'pink-gold'],
    customizable: true,
    features: ['Crystal Tiara', 'Custom Ribbon Text', 'Golden Butterflies', 'Luxury Designer Paper'],
  ...
  },
  {
    ...
    colors: ['pink', 'red', 'white', 'peach', 'emerald-green', 'purple', 'pink-gold'],
    customizable: true,
    features: ['3-Section Letter Box', 'Butterfly Accent', 'Crystal Centers', 'Gift Ribbon'],
  ...
  },
  {
    ...
    colors: ['pink', 'red', 'white', 'peach', 'emerald-green', 'purple', 'pink-gold'],
    customizable: true,
    features: ['Heart Box Design', 'Pearl Strand', 'Butterfly Accents', 'Valentine Tag'],
  ...
  },
  {
    ...
    colors: ['pink', 'red', 'white', 'peach', 'emerald-green', 'purple', 'pink-gold'],
    customizable: true,
    features: ['Golden Butterflies', 'Crystal Centers', 'Premium Wrapping', 'Gift Card'],
  ...
  },
  {
    ...
    colors: ['pink', 'red', 'white', 'peach', 'emerald-green', 'purple', 'pink-gold'],
    customizable: true,
    features: ['Gold Trim', 'Butterfly Accents', 'Designer Paper', 'Thank You Card'],
  ...
  },
  {
    ...
    colors: ['pink', 'red', 'white', 'peach', 'emerald-green', 'purple', 'pink-gold'],
    customizable: true,
    features: ['Letter Box Design', 'Butterfly Accent', 'Gift Ready', 'Crystal Details'],
  ...
  },
  {
    ...
    description: 'Our signature flower purse! A stunning wearable accessory featuring purple sparkling roses, a golden crown accent, and a chic gold chain strap. Truly unique! Eternal beauty that lasts forever!',
    price: 15,
    category: 'purse',
    colors: ['pink', 'red', 'white', 'peach', 'emerald-green', 'purple', 'pink-gold'],
    customizable: false,
    features: ['Golden Crown', 'Gold Chain Strap', 'Black Base', 'Purple Ribbon'],
